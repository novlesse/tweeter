<div class="flex">
    ...
    @csrf
        ...
        <button type="submit" 
            class="flex items-center mr-2 focus:outline-none {{ $tweet->isLikedBy(current_user()) ? 'text-blue-400' : 'text-gray-500'}}">
            <svg 
                viewBox="0 0 20 20" 
                version="1.1" 
    ...
    @method('DELETE')
        ...
        <button type="submit" 
            class="flex items-center ml-2 focus:outline-none {{ $tweet->isDislikedBy(current_user()) ? 'text-blue-400' : 'text-gray-500'}}">
            <svg 
                viewBox="0 0 20 20" 
                version="1.1" 
                xmlns="http://www.w3.org/2000/svg" 
